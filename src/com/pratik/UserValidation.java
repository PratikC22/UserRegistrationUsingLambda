...
public class UserValidation {
    ...
    public void userValidate() {
         ...
         */
        IUser IUserRegistration = (checkPattern, givenInput) -> {
        ...
        IUserRegistration.validateUser(FIRST_NAME_PATTERN, FirstName);
        ...
        IUserRegistration.validateUser(LAST_NAME_PATTERN, LastName);
        ...
        IUserRegistration.validateUser(EMAIL_PATTERN, Email);
        ...
        IUserRegistration.validateUser(MOBILE_PATTERN, MobileNumber);
        ...
        IUserRegistration.validateUser(PASSWORD_PATTERN, Password);
    }
}